...
class Instagram {
  ...
  public function getApiCallback() {
    ...
    $instagram = new Instagram('005f74033e76412fb3f60d823169c757');
    ...
    {
        // Show photo
        //echo '<p><img src="'.$data->images->standard_resolution->url.'" alt="SOME TEXT HERE"></p>';
        echo '<article class="instagram item" data="'.$data->id.'"><a href="'.$data->link.'" target="_blank"><img src="'.$data->images->standard_resolution->url.'" /><div class="description"><span class="date" data-timestamp="'.$data->created_time.'"></span></div></a></article>';
