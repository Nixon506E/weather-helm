 ...
 */
function weatherhelm_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  // Rebuild registry.
  $form['weatherhelm_rebuild_registry'] = array(
    '#type' => 'checkbox',
    '#title' => t('Rebuild theme registry on every page.'),
    '#default_value' => theme_get_setting('weatherhelm_rebuild_registry'),
  ...
  $form['weatherhelm_toggle_selection'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use toggle switches instead of checkboxes'),
    '#default_value' => theme_get_setting('weatherhelm_toggle_selection'),
